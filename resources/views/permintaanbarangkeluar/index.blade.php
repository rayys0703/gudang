                                            ...
                                            <button onclick="showStatusChangeAlert({{ $d->id }})"
                                                ...
                                                <svg class='line' xmlns='http://www.w3.org/2000/svg'
                                                    ...
                                                    <g transform='translate(2.000000, 2.000000)'>
                                                        ...
                                                        <line x1='13.009' y1='3.8008' x2='16.604'
                                                            y2='6.9838'>
                                                        </line>
                                                    </g>
                                                </svg>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="grid grid-cols-2 gap-2">
                                                    ...
                                                    <div class="font-bold">Jenis Barang:</div>
                                                    <div>{{ $d->nama_jenis_barang }}</div>
                                                    <div class="font-bold">Supplier:</div>
                                                    <div>{{ $d->nama_supplier }}</div>
                                                    <div class="font-bold">Penerima:</div>
                                                    <div>{{ $d->nama_customer }}</div>
                                                    <div class="font-bold">Keperluan:</div>
                                                    <div>{{ $d->nama_keperluan }}</div>
                                            ...
                                            <div class="modal-footer gap-x-3">
                                                @if ($d->status == 'Belum Disetujui')
                                                    ...
                                                    <button type="button" class="btn btn-danger"
                                                        onclick="updateStatus({{ $d->id }}, 'Tidak Disetujui')"
                            ...
                            /*function showStatusChangeAlert(id) {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        updateStatus(id, 'Tidak Disetujui');
                                    }
                                });
                            }*/
