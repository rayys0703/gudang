                        ...
                        <div class="permintaan-input-item" data-index="1">
                            ...
                            <div class="mb-5">
                                <label for="jenis_barang_1" class="block mb-2 text-sm font-medium text-gray-900">Jenis
                                    Barang</label>
                                <select id="jenis_barang_1" name="jenis_barang_id[]"
                                    class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="mb-5">
                                ...
                                <select id="barang_1" name="barang_id[]"
                                    class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createPermintaanInput(index) {
                ...
                newItem.innerHTML = `
                    ...
                    <div class="mb-5">
                        <label for="serialnumber_${index}" class="block mb-2 text-sm font-medium text-gray-900">Serial Number</label>
                        <select id="serialnumber_${index}" name="serial_numbers[]"
                            class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            <option selected>Pilih serial number</option>
                        </select>
                    </div>
            ...
            function initializeSelect2() {
                ...
                $('.select2').on('select2:select', function(e) {
                    ...
                    if (selectElement.attr('id').startsWith('barang')) {
                        ...
                        fetch(`/permintaanbarangkeluar/get-by-barang/${barangId}`)
                            .then(response => response.json())
                            .then(data => {
                                const serialNumberSelect = $(`#serialnumber_${index}`);
                                serialNumberSelect.empty();
                                serialNumberSelect.append(
                                    '<option selected>Pilih serial number</option>');
                                data.forEach(serialNumber => {
                                    const option = new Option(serialNumber, serialNumber, false,
                                        false);
