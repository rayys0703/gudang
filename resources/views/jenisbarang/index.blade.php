    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                <table id="jenisbarang-table" class="py-6 px-0 w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        return `
                                                    <div class="flex">
                                                        <a href="/jenisbarang/edit/${data}" class="flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-3 py-1.5 text-center mr-2" type="button">
                                                        ...
                                                        <a href="/jenisbarang/delete/${data}" class="flex text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-3 py-1.5 text-center" type="button">
