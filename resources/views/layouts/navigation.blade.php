<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed top-0 left-0 right-0 z-50">
    ...
    <div class="max-w-7xl max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('statusbarang.index')" :active="request()->routeIs('statusbarang.*')">
                        {{ __('Status Barang') }}
                    </x-nav-link>
                    <x-nav-link :href="route('barang.index')" :active="request()->routeIs('barang.*')">
                        {{ __('Barang') }}
                    </x-nav-link>
                    {{-- <x-nav-link :href="route('serialnumber.index')" :active="request()->routeIs('serialnumber.*')">
                        {{ __('Serial Number') }}
                    </x-nav-link> --}}
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('laporan.stok.index')">
                                    {{ __('Laporan Stok') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('laporan.barangmasuk.index')">
                                    {{ __('Laporan Barang Masuk') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('laporan.barangkeluar.index')">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('jenisbarang.index')" :active="request()->routeIs('jenisbarang.*')">
                {{ __('Jenis Barang') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('statusbarang.index')" :active="request()->routeIs('statusbarang.*')">
                {{ __('Status Barang') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('permintaanbarangkeluar.index')" :active="request()->routeIs('permintaanbarangkeluar.*')">
