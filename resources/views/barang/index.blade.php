                    ...
                    {{-- <tbody>
                        @foreach ($data as $d)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-base text-black">{{ $d->jumlah }}</div>
                                </td>
                                <td class="px-6 py-4">
                    ...
                    $(document).ready(function() {
                        $('#barang-table').DataTable({
                            ...
                            ajax: {
                                ...
                                data: function(d) {
                                    // d['barang.nama'] = $('input[name=nama_barang]').val();
                                    // d.nama_jenis_barang = $('input[name=nama_jenis_barang]').val();
                                    // d.nama_supplier = $('input[name=nama_supplier]').val();
                                    // d.keterangan = $('input[name=keterangan]').val();
                                },
                                headers: {
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        return `
                                            <div class="flex">
                                                <a href="/barang/edit/${data}" class="flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-3 py-1.5 text-center mr-2" type="button">
                                                ...
                                                <a href="/barang/delete/${data}" class="flex text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-3 py-1.5 text-center" type="button">
