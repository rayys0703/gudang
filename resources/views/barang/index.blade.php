<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center gap-x-5">
            <form action="{{ route('barang.index') }}" method="GET" class="flex items-center max-w-sm mx-auto">   
            ...
            <a href="{{ route('barang.create') }}" class="text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-2xl text-sm w-full sm:w-auto py-2 px-3 text-center">Tambah Data</a>
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    {{-- <td class="px-6 py-4">
                                        <div class="text-base text-black">{{ $d->status }}</div>
                                    </td> --}}
                                    <td class="px-6 py-4">
                                        <div class="text-base text-black">{{ $d->keterangan }}</div>
                                    </td>
                                    <td class="px-6 py-4 flex gap-x-2">
                                        <a href="/barang/edit/{{ $d->id }}" type="button"
